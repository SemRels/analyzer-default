...
import (
	...
	grpcserver "github.com/SemRels/analyzer-default/internal/grpc"
	semrelplugin "github.com/SemRels/analyzer-default/internal/plugin"
)

func main() {
	provider := semrelplugin.NewProvider("analyzer-default")
